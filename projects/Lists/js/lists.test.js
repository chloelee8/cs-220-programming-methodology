...
describe("everyNRev", () => {
    ...
    it("should let empty list stays empty", () => {
        assert.deepStrictEqual(listToArray(everyNRev(empty(), 2)), []);
    });
...
describe("everyNCond", () => {
    ...
    it("should return empty list", () => {
        assert.deepStrictEqual(listToArray(everyNCond(empty(), 2, isEven)), []);
    });
...
describe("keepTrendMiddles", () => {
    ...
    it("should return empty for length < 3", () => {
        assert.deepStrictEqual(listToArray(keepTrendMiddles(empty(), () => true)), []);
...
describe("deleteFirst", () => {
    ...
    it("should return empty list", () => {
        assert.deepStrictEqual(listToArray(deleteFirst(empty(), 1)), []);
    });
});
describe("deleteLast", () => {
...
describe("squashList", () => {
    ...
    it("should replace the inner lists with sums", () => {
        assert.deepStrictEqual(listToArray(squashList(arrayToList([1, arrayToList([2, 3]), 4, arrayToList([]), arrayToList([10])]))), [1, 5, 4, 0, 10]);
    });
